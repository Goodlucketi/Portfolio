...
<template>
    <main class="my-15 md:my-30 md:p-10">
        ...
        <div class="about  md:grid md:grid-cols-3 md:gap-5 md:justify-center md:items-center md:w-10/12 mx-auto">
            ...
            <div class="abt-img shadow-lg m-3 rounded-xl mb-7 pb-3" data-aos="zoom-in-up" data-aos-duration="2000">
                ...
                <div class="text p-4">
                    ...
                    <a href="https://perlygatesresidence.netlify.app" class="py-2 px-5 my-3 rounded-md bg-slate-900 text-white">View</a>
                </div>
            </div>
            <div class="abt-img shadow-lg m-3 rounded-xl mb-7 pb-3" data-aos="zoom-in-up" data-aos-duration="2000">
                ...
                <div class="text p-4">
                    ...
                    <p class="text-slate-600 mb-6">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repudiandae, voluptatibus?</p>
                    <a href="https://biwnation.netlify.app" class="py-2 px-5 my-3 rounded-md bg-slate-900 text-white">View</a>
                </div>
            </div>
            <div class="abt-img shadow-lg m-3 rounded-xl mb-7 pb-3" data-aos="zoom-in-up" data-aos-duration="2000">
                ...
                <div class="text p-4">
                    ...
                    <p class="text-slate-600 mb-6">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repudiandae, voluptatibus?</p>
                    <a href="https://melnhub.netlify.app" class="py-2 px-5 my-3 rounded-md bg-slate-900 text-white">View</a>
                </div>
            </div>
            <div class="abt-img shadow-lg m-3 rounded-xl mb-7 pb-3" data-aos="zoom-in-down" data-aos-duration="2000">
                ...
                <div class="text p-4">
                    ...
                    <p class="text-slate-600 mb-6">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repudiandae, voluptatibus?</p>
                    <a href="https://mfoniso-fabian-portfolio.netlify.app" class="py-2 px-5 my-3 rounded-md bg-slate-900 text-white">View</a>
                </div>
            </div>
            <div class="abt-img shadow-lg m-3 rounded-xl mb-7 pb-3" data-aos="zoom-in-right" data-aos-duration="2000">
                ...
                <div class="text p-4">
                    ...
                    <p class="text-slate-600 mb-6">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repudiandae, voluptatibus?</p>
                    <a href="https://zoocasa.netlify.app" class="py-2 px-5 my-3 rounded-md bg-slate-900 text-white">View</a>
                </div>
            </div>
            <div class="abt-img shadow-lg m-3 rounded-xl mb-7 pb-3" data-aos="zoom-in-left" data-aos-duration="2000">
